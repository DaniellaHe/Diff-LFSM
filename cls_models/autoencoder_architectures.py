...
def resnet18_decoder_no_bottleneck_6_12_18_24(latent_dim, input_height, first_conv, maxpool1):
    return ResNetDecoder_no_bottleneck_6_12_18_24(DecoderBlock, [2, 2, 2, 2], latent_dim, input_height, first_conv,
                                                  maxpool1)
...
class AE_no_bottleneck_6_12_18_24(pl.LightningModule):
    ...
    def __init__(
        ...
        self.decoder = resnet18_decoder_no_bottleneck_6_12_18_24(self.latent_dim, self.input_height, first_conv,
                                                                 maxpool1)
...
def resnet18_decoder_no_bottleneck_6_12_16(latent_dim, input_height, first_conv, maxpool1):
    return ResNetDecoder_no_bottleneck_6_12_16(DecoderBlock, [2, 2, 2, 2], latent_dim, input_height, first_conv,
                                               maxpool1)
...
def resnet18_decoder_no_bottleneck_6_12_18_24_large(latent_dim, input_height, batch_size, first_conv, maxpool1):
    return ResNetDecoder_no_bottleneck_6_12_18_24_large(DecoderBlock, [2, 2, 2, 2], 8, 128, batch_size, first_conv,
                                                        maxpool1)
...
class AE_no_bottleneck_6_12_18_24_large(pl.LightningModule):
    ...
    def __init__(
        ...
        self.decoder = resnet18_decoder_no_bottleneck_6_12_18_24_large(self.latent_dim, self.input_height,
                                                                       self.batch_size, first_conv,
                                                                       maxpool1)
...
class AE_no_bottleneck_8_16_32_64(pl.LightningModule):
    ...
    def __init__(
        ...
        self.decoder = resnet18_decoder_no_bottleneck_8_16_32_64(self.latent_dim, self.input_height, first_conv,
                                                                 maxpool1)
...
def resnet18_decoder_no_bottleneck_6_12_16_3d(latent_dim, input_height, first_conv, maxpool1):
    return ResNetDecoder_no_bottleneck_6_12_16_3d(DecoderBlock_3d, [2, 2, 2, 2], latent_dim, input_height, first_conv,
                                                  maxpool1)
...
class AE_no_bottleneck_6_12_16_3d(pl.LightningModule):
    ...
    def __init__(
        ...
        self.decoder = resnet18_decoder_no_bottleneck_6_12_16_3d(self.latent_dim, self.input_height, first_conv,
                                                                 maxpool1)
